...
import { useCancelReservation, usePauseReservation, useUnPauseReservation } from "@/features/reservation/reservation";
          ...
          <div>
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end">
                ...
                {status === "paused" && <DropdownMenuItem role="button" onClick={() => unPauseReservation(group_id)}>Unpause</DropdownMenuItem>}
