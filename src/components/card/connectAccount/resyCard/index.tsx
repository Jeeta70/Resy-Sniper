...
import { ResponseUiForResy } from "@/components";
  ...
  return (
    <Card className={cardStyle}>
      ...
      <div className="border-2 bg-orange flex p-2 rounded-sm gap-2 items-center text-white">
        ...
        <small className="font-semibold">we are not associated with resy  or any other brands </small>
      </div>
      <ResponseUiForResy setdisableContinueButton={setdisableContinueButton} />
    </Card>
  );
};
