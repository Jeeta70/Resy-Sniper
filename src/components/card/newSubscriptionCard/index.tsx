...
type userDetail = { userDetail: string };
...
const Index = ({ subscriptionType, points, userDetail, button, buttonColor, subscriptionAvailaibility }: SubscriptionCardType) => {
                ...
                <div className="sm:flex">
                    ...
                    <div className="p-4 flex-1">
                        ...
                        <Credenza>
                            ...
                            {button === 'Cancel Subscription' ? <><CancelSubscription /></> : <></>}
                        </Credenza>
                    </div>
                </div>
            </CardContent>
